...
public class Variable extends Value {
     ...
     * values to be used as variable inputs in arguments of a Request or
     * Profile. If this constructor is used by Simple Profiles with a
     * specific instance value the input is not treated as a variable reference
     * but as a explicit required input.
     * 
     * @param byValue
     ...
     * values to be used as variable inputs in arguments of a Profile.
     * 
     * @param byTypeURI
