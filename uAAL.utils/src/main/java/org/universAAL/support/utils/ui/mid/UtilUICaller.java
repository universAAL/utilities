...
public abstract class UtilUICaller extends UICaller {
     ...
     *            submit.
     */
    protected UtilUICaller(ModuleContext context, String namespace,
     ...
     */
    private void populate(File dm, String namespace, String url, String title)
	    throws IOException {
	 ...
	 */
	protected UIcallee(ModuleContext context, String namespace, String url,
		String desc, UtilUICaller uicaller) {
	    super(context, new ServiceProfile[] { InitialServiceDialog
		    .createInitialDialogProfile(namespace + "UIService", url,
			    desc, namespace + "startUI") });
