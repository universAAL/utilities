 ...
 * these 4 services. Those considering using UtilEditor could take advantage
 * of this class if they want only to handle those 4 typical services profiles
 * and no more.
 * 
 * @author alfiva
 * 
...
public abstract class UtilEditorCallee extends ServiceCallee {
     ...
     */
    public UtilEditorCallee(ModuleContext context, String namespace,
	    String ontologyURI, String[] path, String editedURI) {
	super(context, UtilEditor.getServiceProfiles(namespace, ontologyURI,
		path, editedURI));
