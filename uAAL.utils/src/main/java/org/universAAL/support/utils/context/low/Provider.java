 ...
 */
package org.universAAL.support.utils.context.low;
 ...
 * around to use the native API to apply further restrictions over the
 * Provider.
 * 
 * @author alfiva
 * 
...
public class Provider extends ContextProvider {
     ...
     */
    public Provider(String uri, ContextProviderType type,
	    String subjTypeURI, String predicate, String objTypeURI) {
	super(uri);
	this.setType(type != null ? type : ContextProviderType.gauge);
	this.setProvidedEvents(new ContextEventPattern[] { new Pattern(
     ...
     */
    public Provider(String uri, ContextProviderType type,
	    ManagedIndividual subj, String predicate, String objTypeURI) {
	super(uri);
	this.setType(type != null ? type : ContextProviderType.gauge);
	this.setProvidedEvents(new ContextEventPattern[] { new Pattern(
		subj, predicate, objTypeURI) });
    }
