...
public class UtilEditor {
	...
	// Get
	Profile prof1 = new Profile((Service) OntologyManagement
		.getInstance()
	...
	// Add
	Profile prof2 = new Profile((Service) OntologyManagement
		.getInstance()
	...
	prof2.service.getProfile().addAddEffect(path,
		input2.asVariableReference());
	profiles[1] = prof2.getTheProfile();

	// Change
	Profile prof3 = new Profile((Service) OntologyManagement
	...
	prof3.service.getProfile().addChangeEffect(path,
		input3.asVariableReference());
	profiles[2] = prof3.getTheProfile();

	// Remove
	Profile prof4 = new Profile((Service) OntologyManagement
		.getInstance().getResource(ontologyURI,
     ...
     *            parameter. The editor GET service will return you the full
     *            Resource with the URI of this argument.
     * @param argOut
     ...
     *         editor
     */
    public static ServiceRequest requestGet(String ontologyURI, String[] path,
     ...
     *            concept to the exact concept you want to manage
     * @param argAdd
     *            Add representing the input you want to pass as
     *            parameter. The editor ADD service will add the full Resource
     *            passed in this argument.
     * @return The ServiceRequest that will call the matching ADD service of an
     *         editor
     */
    public static ServiceRequest requestAdd(String ontologyURI, String[] path,
	    Add argAdd) {
	Request req = new Request((Service) OntologyManagement
		.getInstance().getResource(ontologyURI, null));
	req.put(path, argAdd);
     ...
     *            concept to the exact concept you want to manage
     * @param argChange
     *            Change representing the input you want to pass as
     *            parameter. The editor CHANGE service will replace the Resource
     *            of the same URI with this new value
