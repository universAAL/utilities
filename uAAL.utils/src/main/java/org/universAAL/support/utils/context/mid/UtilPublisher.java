 ...
 * <p/>Example: A publisher that gives events about status of a Heater Actuator.
 * <code>
...
public class UtilPublisher extends DefaultContextPublisher {
     ...
     */
    public UtilPublisher(ModuleContext context, String uri,
	    ContextProviderType type, ContextEventPattern[] pattern) {
     ...
     */
    public UtilPublisher(ModuleContext context, String uri,
	    ContextProviderType type, String subjTypeURI, String predicate,
	    String objTypeURI) {
	super(context, new Provider(uri, type, subjTypeURI, predicate,
		objTypeURI));
    }
     ...
     */
    public UtilPublisher(ModuleContext context, String uri,
	    ContextProviderType type, ManagedIndividual sub, String predicate,
	    String objTypeURI) {
	super(context, new Provider(uri, type, sub, predicate,
		objTypeURI));
    }
