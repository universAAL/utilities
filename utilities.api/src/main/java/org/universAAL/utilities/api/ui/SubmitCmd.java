...
/**
 * Class representing a Submit UI element. Submits are commands that can be
 * issued by the user, whether it's a button, spoken command or any other way,
 * depending on the UI renderer.
 * <p>
 * Example render:
 * <p>
 *
