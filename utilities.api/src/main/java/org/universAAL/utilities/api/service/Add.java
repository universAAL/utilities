...
/**
 * Class representing an Add-type argument in a service request. Arguments are
 * the "leaf" objects at the end of a property path and can be of several types
 * depending on what you want to do with them. An Add-type argument means that
 * the value represented by this argument must be "added" by the service you
 * intend to call.
 *
 * @author alfiva
 *
